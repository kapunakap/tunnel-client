...
"$RELEASE_TAG_SCRIPT" check-source-version v0.0.12-dev
"$RELEASE_TAG_SCRIPT" check-source-version 0.0.12-dev
...
assert_fails_with "source version 0.0.12-dev in pkg/version/VERSION does not match release version 0.0.12" \
